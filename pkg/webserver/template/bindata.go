...
func indexHtmlTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.html.tmpl", size: 145, mode: os.FileMode(438), modTime: time.Unix(1630842656, 0)}
